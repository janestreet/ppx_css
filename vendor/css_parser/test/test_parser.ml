...
let eq_ast ast1 ast2 =
  ...
  and eq_at_rule r1 r2 =
    ...
    | Brace_block.Stylesheet s1, Brace_block.Stylesheet s2 -> eq_stylesheet s1 s2
    | _ -> false
  ...
  and eq_declaration_list (dl1, _) (dl2, _) =
    let eq_kind k1 k2 =
      ...
      | Declaration_list.At_rule r1, Declaration_list.At_rule r2 -> eq_at_rule r1 r2
      | _ -> false
    in
    ...
    ( [ Rule.Style_rule
          ...
          ; block =
              ( [ Declaration_list.Declaration
                    ...
                    ; value =
                        [ Component_value.Ident "red", Location.none ], Location.none
...
|} in
  ...
  let expected_ast =
    ( [ Rule.At_rule
          ...
          ; prelude =
              ( [ Component_value.Uri "http://www.w3.org/1999/xhtml", Location.none ]
              , Location.none )
          ; block = Brace_block.Empty
          ; loc = Location.none
          }
...
|}
  ...
  let expected_ast =
    ( [ Rule.At_rule
          ...
          ; prelude =
              ( [ Component_value.Uri "\"https://www.example.com/\"", Location.none ]
              , Location.none )
          ; block =
              Brace_block.Stylesheet
                ( [ Rule.Style_rule
                      { Style_rule.prelude =
                          [ Component_value.Ident "h1", Location.none ], Location.none
                      ; block =
                          ( [ Declaration_list.Declaration
                                { Declaration.name = "color", Location.none
                                ; value =
...
|}
  ...
  let expected_ast =
    ( [ Rule.At_rule
          ...
          ; prelude = [ Component_value.Ident "slidein", Location.none ], Location.none
          ; block =
              Brace_block.Stylesheet
                ( [ Rule.Style_rule
                      { Style_rule.prelude =
                          [ Component_value.Ident "from", Location.none ], Location.none
                      ; block =
                          ( [ Declaration_list.Declaration
                  ...
                  ; Rule.Style_rule
                      { Style_rule.prelude =
                          [ Component_value.Ident "to", Location.none ], Location.none
                      ; block =
                          ( [ Declaration_list.Declaration
                                { Declaration.name = "margin-left", Location.none
                                ; value =
          ...
          ; block =
              Brace_block.Declaration_list
                ( [ Declaration_list.Declaration
                      ...
                      ; value =
                          [ Component_value.Ident "cyclic", Location.none ], Location.none
                      ; important = false, Location.none
                      ; loc = Location.none
                      }
                  ; Declaration_list.Declaration
                  ...
                  ; Declaration_list.Declaration
                      ...
                      ; value =
                          [ Component_value.String " ", Location.none ], Location.none
                      ; important = false, Location.none
                      ; loc = Location.none
                      }
                  ]
    ...
    ( [ Rule.Style_rule
          ...
          ; block =
              ( [ Declaration_list.Declaration
                    { Declaration.name = "color", Location.none
                    ; value =
                        [ Component_value.Ident "blue", Location.none ], Location.none
                    ; important = false, Location.none
                    ; loc = Location.none
                    }
                ]
    ...
    ( [ Rule.Style_rule
          ...
          ; block =
              ( [ Declaration_list.Declaration
                    { Declaration.name = "margin", Location.none
                    ; value =
                        ( [ ( Component_value.Float_dimension ("-10", "px", Length)
                            , Location.none )
                          ]
                        , Location.none )
                    ; important = false, Location.none
    ...
    ( [ Rule.Style_rule
          ...
          ; block =
              ( [ Declaration_list.Declaration
                    ...
                    ; value = [ Component_value.Number "0", Location.none ], Location.none
                    ; important = false, Location.none
                    ; loc = Location.none
                    }
                ; Declaration_list.Declaration
...
|} in
  ...
  let expected_ast =
    ( [ Rule.At_rule
          ...
          ; prelude = [ Component_value.Ident "div", Location.none ], Location.none
          ; block =
              Brace_block.Stylesheet
                ( [ Rule.Style_rule
                      { Style_rule.prelude =
                          [ Component_value.Ident "span", Location.none ], Location.none
                      ; block =
                          ( [ Declaration_list.Declaration
                                { Declaration.name = "color", Location.none
                                ; value =
...
let test_set =
  ...
  ; "@keyframes with vendor prefixes", `Quick, test_at_rule_keyframes_with_vendor_prefixes
