...
(** [assert_expression_and_pattern_symmetry] asserts that both [expression] and [pattern]
    have been called for all identifiers. *)
val assert_expression_and_pattern_symmetry : here:[%call_pos] -> 'a t -> unit
